pipeline {
	 ...
	 tools {
		 jdk 'jdk-1.8.101' //Preinstalada en la Configuración del Master
		 ...
		 post {
			 ...
			 failure {
				 echo 'This will run only if failed'
					 mail (to: 'edison.mejia@ceiba.com.co',subject: "Failed	Pipeline:${currentBuild.fullDisplayName}",body: "Something is wrong	with ${env.BUILD_URL}")
			 }
